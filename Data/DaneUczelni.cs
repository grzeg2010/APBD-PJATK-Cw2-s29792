...
public static class DaneUczelni
{
    ...
    public static void Inicjalizuj()
    {
        ...
        [
            ...
            new Przedmiot { Id = 7, Nazwa = "Testowanie Oprogramowania", Kategoria = "Quality", Ects = 4, ProwadzacyId = 4, DataStartu = new DateTime(2026, 3, 22), DataZakonczenia = new DateTime(2026, 6, 18) }
        ]);
